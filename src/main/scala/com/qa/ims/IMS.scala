...
import com.qa.ims.controller.ProductController.{findAllProducts, findProductByCategory, findProductById, findProductByName, productCustomer}
...
object IMS {
  ...
  def main(args: Array[String]): Unit = {
    ...
    findProductById("5f6a4ed6010000f2e1325a93")
